...
class EventPost(models.Model):
    ...
    image		 			= models.ImageField(upload_to=upload_location, null=False, blank=False, default='pce_logo.png')
    category                = models.CharField(max_length=10, choices=CATEGORY_CHOICE, default='All')
    event_date              = models.DateField(auto_now=False, auto_now_add=False, null=False, blank=False, verbose_name="event date")
