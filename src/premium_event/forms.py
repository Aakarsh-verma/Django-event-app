...
from event.models import PremiumEventPost


class CreatePremiumEventPostForm(forms.ModelForm):
    class Meta:
        model = PremiumEventPost
        fields = [
            "title",
            "body",
            "category",
...
class UpdatePremiumEventPostForm(forms.ModelForm):
    class Meta:
        model = PremiumEventPost
        fields = [
            "title",
